...
import Models.SMSModule.GetSMSResponse;
import Models.SMSModule.SMSModuleApiResponseData;
...
public class SecondLab {
    ...
    public void SMSModuleDB () throws SQLException {
        ...
        List<GetSMSRequest> getSMSRequests = getSMSRequestLists(DataControllerSMSModule.queryGetNumbers);
